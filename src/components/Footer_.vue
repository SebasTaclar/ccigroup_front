    ...
    <div class="footer-top">
      <div class="footer-container">
        <div class="footer-grid">
          ...
          <div class="footer-col">
            <h4 class="footer-col-title">Enlaces importantes</h4>
            <ul class="footer-links">
              <li><a href="#translations">Traducciones certificadas</a></li>
              <li><a href="#admin-support">Soporte administrativo</a></li>
              <li><a href="#interpretation">Interpretación presencial</a></li>
            </ul>
          </div>
          ...
          <div class="footer-col">
            ...
            <div class="social-icons">
              ...
              <a href="https://www.instagram.com/ccigroup.multilingual/" target="_blank" rel="noopener" class="social-icon" title="Instagram">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
...
// Footer component for CCI Group
</script>
